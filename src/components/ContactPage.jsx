...
export default function ContactPage(){
  ...
  const onSubmit = async(data) => {
    ...
    try{
        const result = await axios.post("https://getform.io/f/amdymovb", userInfo)
        // alert("Message Sent")
            ...
            <div className="contactSection">
                ...
                <div className="directContact">
                    ...
                    <div className="reachMeDetails">
                        <a className="contactLinks" target="_blank" href="mailto:agishita13@gmail.com">
                            <IoMdMail size={24} />
                            <div className="reachPart">agishita13@gmail.com</div>

                        </a>
                        <a className="contactLinks" target="_blank" href="tel:+919528481950">
                            <FaPhoneAlt size={24} />
                            <div className="reachPart">+91-9528481950</div>
                        </a>
                    </div>
                </div>
            </div>
