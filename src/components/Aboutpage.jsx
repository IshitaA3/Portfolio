...
// export default tools;
    ...
    return (
      ...
      <div className="educationItem">
        <div className="eduYear">2020 – 2021</div>
        <div className="eduDegree">Senior Secondary (Class XII, PCM)</div>
        <div className="eduInstitute">KL International School, Meerut</div>
      </div>

      <div className="educationItem">
        <div className="eduYear">2018 – 2019</div>
        <div className="eduDegree">Secondary (Class X)</div>
        <div className="eduInstitute">St. Francis Convent School, Meerut</div>
      </div>
                </div>
            </div>
